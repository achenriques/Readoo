module.exports = {
    ...
    updateKarma: "UPDATE app_user u app_user u INNER JOIN book b SET u.userKarma = CASE " + 
            "WHEN ? > 0 THEN u.userKarma + 1 WHEN ? < 0 AND u.userKarma > 0 THEN u.userKarma -1 ELSE u.userKarma END WHERE b.bookId = ? ;"
}